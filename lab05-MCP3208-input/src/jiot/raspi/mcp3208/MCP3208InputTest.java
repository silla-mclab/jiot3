...
public class MCP3208InputTest {
    ...
    public MCP3208InputTest(String spiDevId, String ssPinId) throws IOException {
    ...
    public static void main(String[] args) {
        ...
        MCP3208InputTest adcDev;
        
        try {
            adcDev = new MCP3208InputTest("SPI0.1", "GPIO7");
            adcDev.run();
